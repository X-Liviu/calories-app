# Día 9 - Desarrollo de la aplicación Fullstack (React, Node.js y Express)
...
- Modificado el GET de /my-aliments, ahora ya no devuelve el user de cada alimento propio, ya que de momento no estoy usando esa información, y tampoco se me ocurre algún motivo por el cual usar esa información de la petición. Modificadas la mayoría de las peticiones del controller weeks de la misma manera.

- Creada la solicitud **PUT** para modificar el peso del alimento de una comida.

### Frontend

- Funcionalidad de poder **modificar el peso de los alimentos dentro de una comida**.

- Corregido el componente **Toggable** para poder usar su toggleVisibility desde fuera.

- Corregido el cálculo respecto a 100g de los valores nutricionales de cada alimento.
