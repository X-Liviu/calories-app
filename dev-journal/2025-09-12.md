# Día 13 - Desarrollo de la aplicación Fullstack (React, Node.js y Express)
...
- **Separación en varios controllers** de weeks para entender mejor y separar el código de mejor manera.

- **Añadido el campo custom_kcal al modelo de MealAliment** para los alimentos personalizados (añadidos de manera manual).

### Frontend

- Al añadir un alimento a una comida, que los alimentos disponibles de **AlimentCatalogSelectorForm** no aparezcan.

- Componente **AlimentForm** para poder añadir alimentos personalizados (añadidos de manera manual).

- Modificados los **selectors** para que ahora tome en cuenta los alimentos personalizados (añadidos de manera manual).

- Implementado loading, error en el custom hook **useWeeks**.
...
- Usar paquete **weeknumber** para poner los días en los que está comprendida una semana en concreto.
