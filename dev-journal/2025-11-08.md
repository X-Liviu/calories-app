# Día 26 - Desarrollo de la aplicación Fullstack (React, Node.js y Express)
...
- Refactorizado el paquete weeknumber al package.json principal.

### Backend

- Ahora el POST de users **no devuelve nada**.

- Modelo User **se le agrega el atributo registrationDate**.

- El login ahora devuelve el **año en el que se registró ese usuario por primera vez**.

- Modificado **validations.js** para que concuerde con las validaciones del frontend.

### Frontend

- Modificado **validations.js** para que concuerde con las validaciones del backend.

- Modificados **WeekSearch, WeekForm, WeekList, AlimentForm, AlimentCatalogSelectorForm** de acuerdo con las validaciones.

- Modificado **WeekItemList** para que use correctamente daysOfIsoWeek.

- SOPORTE AÑO: Nuevo custom hook **useYear.js** para hacer cambios en su reducer respectivo.<br> Nuevo archivo **yearReducer.js** para guardar el año desde que el usuario está registrado y poder hacer las consultas de las semanas dependiendo del año seleccionado. Añadido a la store.<br>Modificado el custom hook **useInitWeeks.js** para que le pase el año al reducer.<br>Modificado el reducer **weekReducer.js** para que le pase el año al service.<br>Modificado el service **weeks.js** para que acepte el query string del año a la hora de hacer GET de las semanas.
...
- Ahora mismo, al hacer npm install, **se me instala en el frontend, el node_modules**, cosa que no quiero puesto que estoy con la idea de mono-repo, aunque creo que es algo interno de Vite que no permite lo contrario.
