# Día 16 - Desarrollo de la aplicación Fullstack (React, Node.js y Express)
...
- Añadido renders condicionales en **DayItem y Mealtem**.

- Añadida la llamada de **useMyAliments** y lógica acorde en el componente **MealItem** para que reaccione correctamente a los cambios que puedan ocurrir con los elemento del catálogo sin volverse a montar el componente.

## Lo que se desea realizar:

### Backend

- Corregir qué información y de qué manera me tiene que devolver la API. <--
...
- DÍA BASTANTE MEDIOCRE, mucha frustración intentando conseguir que al recargar la página en un ...Item componente, que haga la petición automática a la API sin duplicarse ni hacer peticiones infinitas.
