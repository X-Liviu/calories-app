import { weeksPerYear, weekNumber } from "weeknumber";
...
function isoWeekStart(week, year) {
  ...
  if (week < 1 || week > maxWeeks) {
    throw new RangeError(
      `week debe estar entre 1 y ${maxWeeks} para el año ${year}`,
    );
  }
...
export function daysOfIsoWeek(week, year, outputForm) {
...
const year = 2024,
  week = 38;
const dias = daysOfIsoWeek(year, week).map(formatLocalYYYYMMDD);
console.log(dias);
// Salida esperada: ['2025-09-08','2025-09-09','2025-09-10','2025-09-11','2025-09-12','2025-09-13','2025-09-14']
 */
